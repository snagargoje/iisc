function [LL, prior, transmat, mu, Sigma, mixmat, loglik3, mu1, sigma1, mu2, sigma2, mu3, sigma3] = ...
     mhmm_em_dump(data, prior, transmat, mu, Sigma, mixmat, varargin);
