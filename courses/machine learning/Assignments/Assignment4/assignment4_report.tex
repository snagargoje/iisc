...
\assignmentreport{4}{Mar 13, 2012}{Sachin Nagargoje}{04-04-00-10-41-11-1-08449}
...
Part A.2 \\
  Refer to code \\
\begin{center}
\scalebox{0.25}{\includegraphics{Problem1a/1a11}}
\end{center}
Part A.3 \\
  Refer to code \\
\begin{center}	
\scalebox{0.4}{\includegraphics{Problem1a/1a34}}
\end{center}
\newpage
Contour for 3 iterations\\
\begin{center}
 

\scalebox{0.5}{\includegraphics{Problem1a/1a31}}
\end{center}
Contour for 6 iterations\\
\begin{center}
\scalebox{0.5}{\includegraphics{Problem1a/1a32}}
 
\end{center}
\newpage
Contour for 9 iterations\\
\begin{center}
 
\scalebox{0.5}{\includegraphics{Problem1a/1a33}}
\end{center}
